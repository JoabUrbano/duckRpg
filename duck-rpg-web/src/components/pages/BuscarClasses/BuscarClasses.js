...
import {
  GiAbdominalArmor as Fighter,
  GiPointySword as Barbarian,
  GiAncientSword as Paladin,
  GiAnimalSkull as Warlock,
  GiAnkh as Cleric,
  GiAnthem as Bard,
  GiArcher as Ranger,
  GiBarbedNails as Druid,
  GiBeamsAura as Monk,
  GiBookmarklet as Wizard,
  GiBroadDagger as Rogue,
  GiFlamedLeaf as Sorcerer,
} from "react-icons/gi";
    ...
    <div className="min-h-screen bg-cor-bg p-4">
      <ul className="text-2xl p-2 text-center">
        <li className="flex p-1 pb-2 rounded-b-xl border-2 border-orange-500 font-bold">
          ...
          <div className="w-1/3">Hit Die</div>
        </li>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Barbarian /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Bard /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Cleric /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Druid /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Fighter /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Monk /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Paladin /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Ranger /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Rogue /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Sorcerer /></div>

          <div className="w-1/3">6</div>
        </li>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Warlock /></div>
        ...
        <li className="p-1 border-b-2 border-orange-500 flex">
          ...
          <div className="w-1/3 flex items-center justify-center"><Wizard /></div>
